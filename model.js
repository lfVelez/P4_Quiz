...
// Es un fichero de texto en el JSON de quizzes.
const DB_FILENAME = "quizzes.json";


//Modelo de datos.

//En una variable se mantienen todos los quizzes existentes.
 ...
 *  La primera vez que se ejecute este método, ek fichero DB_FILENAME no
 *  existe, y se producirá el error ENOENT. En este caso se salva el contenido inicial almacenado en quizzes.
...
/**
 * Devuelve el total de preguntas existentes.
 *
 ...
 *
 * @param id        Clave del quiz para actualizar.
 * @param question  String con la pregunta.
 * @param answer    String con la respuesta.
 */
 ...
 *
 * @returns {questinon, answer} Devuelve el objeto quiz de la posición dada
 */
